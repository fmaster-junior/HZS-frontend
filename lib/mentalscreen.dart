...
class _BrainScreenState extends State<BrainScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Mentalno Zdravlje"),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      todayMood > 0
                          ? ['Loše', 'Osrednje', 'Dobro', 'Odlično'][todayMood -
                                1]
                          : 'Nije uneseno',
              ...
              BlocBuilder<AppCubit, AppState>(
                builder: (context, state) {
                  final hasData = state.weeklyMentalData.any((d) => d > 0);
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: List.generate(7, (index) {
                                final value = state.weeklyMentalData[index];
                                return Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (selectedDayLog!['note'] != null &&
                          selectedDayLog!['note'].toString().isNotEmpty) ...[
                        const SizedBox(height: 15),
                        const Text(
                          'Beleška:',
                          style: TextStyle(
